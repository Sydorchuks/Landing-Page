...
interface HeaderProps {
    title: string;  // Explicitly define the type of 'title'
  }
...
const Header = () => {
    ...
    const NavLink:FC<HeaderProps> =({title})=>(
        <LinkScroll
  ...
  return (
    <header       className={clsx(
        ...
        <img src="/images/xora.svg" alt='hamButton' width={115} height={55}/>
        </a>
            <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0', isOpen ? 'max-lg:opacity-100' : 'max-lg:pointer-events-none')}>
                ...
                max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4'>
                <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto '>
                    ...
                    <li className='nav-li'>
                        ...
                        <li className='nav-logo'>
                            ...
                            >
                                <img src='/images/xora.svg' alt='xoraImg' width={160} height={55} />
                            </LinkScroll>
                        </li>
            ...
            onClick={() => setIsOpen(
               (prevState) => !prevState 
                ...
                <img src={`/images/${isOpen ? 'close' : 'magic'}.svg`} alt='hamButton' className='size-1/2 object-contain'/>
            </button>
        </div>
    </header>
  )
